...
let numeroLimite = 10; // Define o limite máximo para o número secreto
...
function exibirMensagemInicial() {
    ...
    exibirTextoNaTela('p', `Escolha um número entre 1 e ${numeroLimite}`); // Exibe a instrução para o jogador
}
